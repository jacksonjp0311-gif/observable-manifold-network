...
RCC-N route maps, Echo template, protocol, and handoff contract.
...
- Shell: middle
- Meridian(s): agent, drift, documentation, safety
- Sector: rcc
...
RCC-N route maps, Echo Location protocol, and agent handoff surface.
