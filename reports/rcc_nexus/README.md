...
- Shell: outer
- Meridian(s): evidence, drift, documentation
- Sector: rcc
...
RCC-N checker and measurement reports.
...
- Local files in `reports/rcc_nexus`
...
- Shell: outer
- Meridian(s): agent, drift, evidence
- Sector: reports
- Version / TTL: RCC-N-v1.0 / 180 days
