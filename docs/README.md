...
Documentation shell for architecture, theory, context, protocols, and injections.
...
Repository documentation, theory, architecture, benchmarks, and governance surface.
