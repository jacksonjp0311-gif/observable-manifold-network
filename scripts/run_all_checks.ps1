...
Write-Host ""
Write-Host "2. Architecture contract validation" -ForegroundColor Cyan
python scripts/validation/validate_architecture_contracts.py

Write-Host ""
Write-Host "3. Unit tests" -ForegroundColor Cyan
python -m unittest discover -s tests

Write-Host ""
Write-Host "4. Runtime seeds" -ForegroundColor Cyan
python -m omn run --seed synthetic-toy
python -m omn run --seed lorenz
python -m omn run --seed artifact-graph

Write-Host ""
Write-Host "5. Evidence validation" -ForegroundColor Cyan
